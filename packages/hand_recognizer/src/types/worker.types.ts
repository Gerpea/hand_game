...
export type DetectorWorkerMessage = DetectorWorkerImageMessage | DetectorWorkerBoxesMessage | DetectorWorkerParamsMessage | WorkerInitMessage

export interface DetectorWorker extends Omit<Worker, 'postMessage'> {
    postMessage(command: DetectorWorkerMessage): void;
}

export type ClassificationWorkerMessage = ClassificationWorkerRequestMessage | ClassificationWorkerResponseMessage | WorkerInitMessage;
